...
`
  ...
  const deleteAllData = async () => {
    try {
      ...
      // Reload the database structure (this will recreate the database with empty tables)
      await loadData()
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] max-w-[1200px] mx-auto w-full">
      ...
      <div className="flex-none w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3 sm:mb-4 w-full">
          <div className="relative w-full">
            ...
            <div
              className="flex gap-2 overflow-x-auto scrollbar-hide pb-2 sm:pb-0 snap-x snap-mandatory swipe-hint sm:swipe-hint-none w-full max-w-full"
              style={{
            ...
            >
              <div className="flex gap-2 min-w-max">
                ...
                >
                  ...
                  <span className="hidden sm:inline">{showForm ? "Cancel" : "New Goal"}</span>
                </Button>
                <Button
                  variant="outline"
                  size="sm"
                    ...
                    {!collapsedGoals[goal.id] && (
                      <CustomDropdown
                        items={[
                          ...
                          {
                            label: goal.sharable !== false ? "Make Private" : "Publish",
                            icon:
                              goal.sharable !== false ? (
      ...
      <MobileDialog
        ...
        title="Delete All Data"
        description="Are you sure you want to delete ALL data? This will remove all goals, tabs, and progress. This action cannot be undone."
